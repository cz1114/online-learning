...
<head>
    ...
    <link rel="stylesheet" href="${request.contextPath}/im/assets/fonts/material-icon/css/material-design-iconic-font.min.css">
    <link rel="stylesheet" href="${request.contextPath}/im/assets/vendor/bootstrap-datepicker/css/bootstrap-datepicker.min.css">
    <link rel="stylesheet" href="${request.contextPath}/im/assets/css/style.min.css">
    <style>
    ...
    <div class="navigation navbar justify-content-center py-xl-4 py-md-3 py-0 px-3">
        ...
        <div class="nav flex-md-column nav-pills flex-grow-1" role="tablist" aria-orientation="vertical"><a
                    class="mb-xl-3 mb-md-2 nav-link" data-toggle="pill" href="#nav-tab-user" role="tab"><img
                        src="${request.contextPath}/im/assets/images/user.png" class="avatar sm rounded-circle" alt="user avatar"/></a><a
        ...
        <div class="tab-content">
            <div class="tab-pane fade" id="nav-tab-user" role="tabpanel">
                ...
                <div class="card border-0 text-center pt-3 mb-4">
                    <div class="card-body">
                        <div class="card-user-avatar"><img src="${request.contextPath}/im/assets/images/user.png" alt="avatar"/>
                            ...
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        ...
                                        <img class="avatar rounded-circle" src="${request.contextPath}/im/assets/images/xs/avatar5.jpg"
                                             alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                                    ...
                                    <div class="media-body overflow-hidden">
                                        ...
                                        <div class="text-truncate">
                                            ...
                                            <div class="avatar-list avatar-list-stacked mt-1">
                                                <img class="avatar xs rounded" src="${request.contextPath}/im/assets/images/xs/avatar5.jpg"
                                                     data-toggle="tooltip" data-placement="top" title="Sean">
                                                <img class="avatar xs rounded" src="${request.contextPath}/im/assets/images/xs/avatar6.jpg"
                                                     data-toggle="tooltip" data-placement="top" title="Martin">
                                                <img class="avatar xs rounded" src="${request.contextPath}/im/assets/images/xs/avatar1.jpg"
                                                     data-toggle="tooltip" data-placement="top" title="Terry">
                                                <img class="avatar xs rounded" src="${request.contextPath}/im/assets/images/xs/avatar4.jpg"
                        ...
                        <a href="single-chat-2.html" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <span class="status rounded-circle"></span>
                                        <img class="avatar rounded-circle" src="${request.contextPath}/im/assets/images/xs/avatar1.jpg"
                                             alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <span class="status rounded-circle"></span>
                                        <img class="avatar rounded-circle" src="${request.contextPath}/im/assets/images/xs/avatar2.jpg"
                                             alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <span class="status rounded-circle"></span>
                                        <img class="avatar rounded-circle" src="${request.contextPath}/im/assets/images/xs/avatar3.jpg"
                                             alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <span class="status rounded-circle"></span>
                                        <img class="avatar rounded-circle" src="${request.contextPath}/im/assets/images/xs/avatar4.jpg"
                                             alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <span class="status rounded-circle"></span>
                                        <img class="avatar rounded-circle" src="${request.contextPath}/im/assets/images/xs/avatar6.jpg"
                                             alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body overflow-hidden">
                                        ...
                                        <div class="text-truncate">
                                            ...
                                            <div class="avatar-list avatar-list-stacked mt-1">
                                                <img class="avatar xs rounded" src="${request.contextPath}/im/assets/images/xs/avatar7.jpg"
                                                     data-toggle="tooltip" data-placement="top" title="Sean">
                                                <img class="avatar xs rounded" src="${request.contextPath}/im/assets/images/xs/avatar8.jpg"
                                                     data-toggle="tooltip" data-placement="top" title="Martin">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <li>
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <img class="avatar rounded-circle" src="${request.contextPath}/im/assets/images/xs/avatar10.jpg"
                                             alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                    ...
                    <li>
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <img class="avatar rounded-circle" src="${request.contextPath}/im/assets/images/xs/avatar9.jpg"
                                             alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                    ...
                    <li>
                        ...
                        <a href="#" class="card">
                            <div class="card-body">
                                <div class="media">
                                    <div class="avatar me-3">
                                        <img class="avatar rounded-circle" src="${request.contextPath}/im/assets/images/xs/avatar8.jpg"
                                             alt="avatar">
                                    </div>
                                    <div class="media-body overflow-hidden">
                                        <div class="d-flex align-items-center mb-1">
                            ...
                            <div class="row align-items-center">
                                <div class="col">
                                    <div class="d-flex align-items-center">
                                        <img src="${request.contextPath}/im/assets/images/xs/avatar6.jpg" data-toggle="tooltip" title=""
                        ...
                        <div class="col-6 col-xl-4">
                            <div class="media">
                                <div class="me-3 show-user-detail">
                                    <span class="status rounded-circle"></span>
                                    <img class="avatar rounded-circle" src="${request.contextPath}/im/assets/images/xs/avatar5.jpg" alt="avatar">
                                </div>
                                <div class="media-body overflow-hidden">
                                    <div class="d-flex align-items-center mb-1">
                                        <h6 class="text-truncate mb-0 me-auto">Jason Porter</h6>
                    ...
                    <ul class="list-unstyled py-4">
                        ...
                        <li class="d-flex message">
                            ...
                            <div class="mr-lg-3 me-2">
                                <img class="avatar sm rounded-circle" src="${request.contextPath}/im/assets/images/xs/avatar5.jpg" alt="avatar">
                            </div>
                                ...
                                <div class="message-row d-flex align-items-center justify-content-end">
                                    ...
                                    <div class="message-content border p-3">
                                        ...
                                        <div class="attachment right-file">
                                            <img class="rounded mt-1" src="${request.contextPath}/im/assets/images/image-file/one-page-work-1.jpg"
                                                 alt=""/>
                                            <img class="rounded mt-1" src="${request.contextPath}/im/assets/images/image-file/one-page-work-2.jpg"
                                                 alt=""/>
                                            <img class="rounded mt-1" src="${request.contextPath}/im/assets/images/image-file/one-page-work-3.jpg"
                                                 alt=""/>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li class="d-flex message">
                            <div class="mr-lg-3 me-2"><img class="avatar sm rounded-circle"
                                                           src="${request.contextPath}/im/assets/images/xs/avatar5.jpg" alt="avatar"></div>
                            <div class="message-body">
                                <div class="message-row d-flex align-items-center">
                                    <div class="message-content p-3">
            ...
            <div class="d-flex flex-column">
                ...
                <div class="body mt-4">
                    <div class="d-flex justify-content-center">
                        <div class="avatar xxl"><img class="avatar xxl rounded-circle"
                                                     src="${request.contextPath}/im/assets/images/sm/avatar2.jpg" alt="avatar"></div>
                    </div>
                    ...
                    <ul class="chat-list">
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        <div class="avatar me-3"><img class="avatar rounded-circle"
                                                                      src="${request.contextPath}/im/assets/images/xs/avatar1.jpg" alt="avatar"></div>
                                        <div class="media-body overflow-hidden">
                        ...
                        <li><a href="#" class="card">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="avatar me-3"><img class="avatar rounded-circle"
                                                                      src="${request.contextPath}/im/assets/images/xs/avatar2.jpg" alt="avatar"></div>
                                        <div class="media-body overflow-hidden">
                                            <div class="d-flex align-items-center mb-1"><h6
                        ...
                        <li><a href="#" class="card">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="avatar me-3"><img class="avatar rounded-circle"
                                                                      src="${request.contextPath}/im/assets/images/xs/avatar3.jpg" alt="avatar"></div>
                                        <div class="media-body overflow-hidden">
                                            <div class="d-flex align-items-center mb-1"><h6
                        ...
                        <li>
                            ...
                            <a href="#" class="card">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="avatar me-3"><img class="avatar rounded-circle"
                                                                      src="${request.contextPath}/im/assets/images/xs/avatar1.jpg" alt="avatar">
                                        </div>
                                        <div class="media-body overflow-hidden">
                                            <div class="d-flex align-items-center mb-1"><h6
                        ...
                        <li>
                            ...
                            <a href="#" class="card">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="avatar me-3"><img class="avatar rounded-circle"
                                                                      src="${request.contextPath}/im/assets/images/xs/avatar3.jpg" alt="avatar">
                                        </div>
                                        <div class="media-body overflow-hidden">
                                            <div class="d-flex align-items-center mb-1"><h6
                        ...
                        <li>
                            ...
                            <a href="#" class="card">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="avatar me-3"><img class="avatar rounded-circle"
                                                                      src="${request.contextPath}/im/assets/images/xs/avatar4.jpg" alt="avatar">
                                        </div>
                                        <div class="media-body overflow-hidden">
                                            <div class="d-flex align-items-center mb-1"><h6
                        ...
                        <li>
                            ...
                            <a href="#" class="card">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="avatar me-3"><img class="avatar rounded-circle"
                                                                      src="${request.contextPath}/im/assets/images/xs/avatar5.jpg" alt="avatar">
                                        </div>
                                        <div class="media-body overflow-hidden">
                                            <div class="d-flex align-items-center mb-1"><h6
                        ...
                        <li>
                            ...
                            <a href="#" class="card">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="avatar me-3"><img class="avatar rounded-circle"
                                                                      src="${request.contextPath}/im/assets/images/xs/avatar6.jpg" alt="avatar">
                                        </div>
                                        <div class="media-body overflow-hidden">
                                            <div class="d-flex align-items-center mb-1"><h6
                        ...
                        <li>
                            ...
                            <a href="#" class="card">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="avatar me-3"><img class="avatar rounded-circle"
                                                                      src="${request.contextPath}/im/assets/images/xs/avatar8.jpg" alt="avatar">
                                        </div>
                                        <div class="media-body overflow-hidden">
                                            <div class="d-flex align-items-center mb-1"><h6
                        ...
                        <li>
                            ...
                            <a href="#" class="card">
                                <div class="card-body">
                                    <div class="media">
                                        <div class="avatar me-3"><img class="avatar rounded-circle"
                                                                      src="${request.contextPath}/im/assets/images/xs/avatar9.jpg" alt="avatar">
                                        </div>
                                        <div class="media-body overflow-hidden">
                                            <div class="d-flex align-items-center mb-1"><h6
